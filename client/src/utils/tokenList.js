...
// function getNewTokenList() {
//   let newTokenList = {};
//   Object.keys(TOKEN_LIST[1]).forEach(key => {
//     if(key === '0x0000000000000000000000000000000000000000') {
//       newTokenList[key] = {
//         [NAME]: TOKEN_LIST[1][key].name,
//         [SYMBOL]: TOKEN_LIST[1][key].symbol,
//         [DECIMALS]: TOKEN_LIST[1][key].decimals,
//         [LOGO]: 'https://cdn.iconscout.com/icon/free/png-256/ethereum-3-569581.png'
//       };
//     } else if(urlExists(`https://raw.githubusercontent.com/trustwallet/assets/master/blockchains/ethereum/assets/${key}/logo.png`)) {
//       newTokenList[key] = {
//         [NAME]: TOKEN_LIST[1][key].name,
//         [SYMBOL]: TOKEN_LIST[1][key].symbol,
//         [DECIMALS]: TOKEN_LIST[1][key].decimals,
//         [LOGO]: `https://raw.githubusercontent.com/trustwallet/assets/master/blockchains/ethereum/assets/${key}/logo.png`
//       };
//     } else {
//       newTokenList[key] = {
//         [NAME]: TOKEN_LIST[1][key].name,
//         [SYMBOL]: TOKEN_LIST[1][key].symbol,
//         [DECIMALS]: TOKEN_LIST[1][key].decimals,
//         [LOGO]: 'https://assets-global.website-files.com/5cb0ac9c57054973ac1bf1e4/5cd059557473d12c2ea50768_2165.png'
//       };
//     }
//   });
//   return newTokenList;
...
// const newTokenList = getNewTokenList();
